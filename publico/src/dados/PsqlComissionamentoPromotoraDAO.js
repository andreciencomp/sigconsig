...
class PsqlComissionamentoPromotoraDAO {
    ...
    async obterPorId(id) {
        try {
            const strQuery = "select comissionamentos_promotora.id, comissionamentos_promotora.percentagem, " +
                ...
                "where comissionamentos_promotora.id=$1";
            ...
            return this.criarObjetoComissionamentoPromotora(result.rows[0]);
    ...
    criarObjetoComissionamentoPromotora(row) {
