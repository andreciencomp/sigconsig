...
const roteadorComissionamentoPromotora = require('./routes/comissionamento_promotora-rotas');
const roteadorComissionamentoCorretor = require('./routes/comissionamento_corretor-rotas');
const roteadorContratos = require('./routes/contratos-rotas');
const roteadorPagamentoComissao = require('./routes/pagamentos_comissoes-rotas');
...
app.use('/', roteadorComissionamentoPromotora);
app.use('/', roteadorComissionamentoCorretor);
